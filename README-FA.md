...
نسخهٔ 2.2.3 میان‌برهای جهت را مستقل از ترتیب فشردن و رهاکردن Ctrl و Shift
اعمال می‌کند، بدون اینکه `Ctrl+Shift+Arrow` جهت متن را تغییر دهد. همچنین جهت
و تراز آخرین پاراگراف پس از پاک‌کردن کامل سند حفظ می‌شود و تبدیل پاراگراف‌های
RTL به Bullet یا Numbering دیگر آن‌ها را به LTR و چپ‌چین برنمی‌گرداند.

# GrassiNotes 2.2.2

نسخهٔ 2.2.2 نمایش markerهای Bullet و Numbering را در RTL و LTR بازمی‌گرداند
و میان‌بر تغییر جهت را فقط بعد از رهاشدن یک ترکیب تمیز Ctrl+Shift اعمال
می‌کند؛ بنابراین `Ctrl+Shift+Arrow` فقط متن را انتخاب می‌کند. گزینهٔ
Automatic به منوی رنگ اضافه شده، عنوان پنجره شمارهٔ نسخه را نشان می‌دهد و
آیکون هدر با مسیر برداری SVG مخصوص تم روشن/تاریک رندر می‌شود.
