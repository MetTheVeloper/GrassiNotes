...
- جهت صریح RTL/LTR در Metadata برنامه حفظ و پس از هر تغییر متن دوباره روی Paragraph و List اعمال می‌شود.
- جهت و تراز پاراگراف جدید پس از Enter از پاراگراف قبلی به ارث می‌رسد.
- Enter پس از Heading 1 تا Heading 4، خط جدید را با سبک Normal ایجاد می‌کند.
