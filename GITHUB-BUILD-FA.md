...
- `GrassiNotes-2.1.5-x64.exe`
- `GrassiNotes-Portable-2.1.5.zip`
- `GrassiNotes-Setup-2.1.5.exe`
- `GrassiNotes-2.1.5-SHA256.txt`
...
6. پایین صفحه، در بخش **Artifacts**، فایل `GrassiNotes-2.1.5-Windows` را دانلود کنید.
