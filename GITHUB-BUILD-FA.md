...
- `GrassiNotes-2.1.4-x64.exe`
- `GrassiNotes-Portable-2.1.4.zip`
- `GrassiNotes-Setup-2.1.4.exe`
- `GrassiNotes-2.1.4-SHA256.txt`
...
6. پایین صفحه، در بخش **Artifacts**، فایل `GrassiNotes-2.1.4-Windows` را دانلود کنید.
